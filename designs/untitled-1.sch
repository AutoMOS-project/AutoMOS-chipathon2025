...
N 400 -590 400 -560 {lab=D}
N 400 -510 400 -500 {lab=GND}
N 240 -1020 240 -990 {lab=VDD}
N 240 -820 240 -790 {lab=VSS}
N 310 -940 340 -940 {lab=#net1}
N 310 -870 340 -870 {lab=#net2}
N 140 -940 170 -940 {lab=#net2}
N 140 -870 170 -870 {lab=CLK}
N 340 -870 440 -870 {lab=#net2}
N 440 -1050 440 -870 {lab=#net2}
N 120 -1050 440 -1050 {lab=#net2}
N 120 -1050 120 -940 {lab=#net2}
N 120 -940 140 -940 {lab=#net2}
N 620 -1020 620 -990 {lab=VDD}
N 620 -820 620 -790 {lab=VSS}
N 690 -940 720 -940 {lab=f_4}
N 690 -870 720 -870 {lab=#net3}
N 520 -940 550 -940 {lab=#net3}
N 520 -870 550 -870 {lab=#net1}
N 720 -870 820 -870 {lab=#net3}
N 340 -940 490 -940 {lab=#net1}
N 490 -940 490 -870 {lab=#net1}
N 490 -870 520 -870 {lab=#net1}
N 820 -1050 820 -870 {lab=#net3}
N 520 -1050 820 -1050 {lab=#net3}
N 520 -1050 520 -940 {lab=#net3}
...
.endc
"}
C {vsource.sym} 140 -650 0 0 {name=V1 value=3.3 savecurrent=false}
...
C {vsource.sym} 280 -650 0 0 {name=V4 value="PULSE(0 1.8 0 10p 10p 0.833n 1.667n)" savecurrent=false
...
C {vsource.sym} 400 -540 0 0 {name=V2 value="PULSE(0 1.8 0 10p 10p 0.833n 1.667n)" savecurrent=false

}
C {gnd.sym} 400 -500 0 0 {name=l4 lab=GND}
C {lab_pin.sym} 400 -590 0 0 {name=p4 sig_type=std_logic lab=D}
...
C {lab_pin.sym} 380 -870 1 1 {name=p7 sig_type=std_logic lab=f_2}
