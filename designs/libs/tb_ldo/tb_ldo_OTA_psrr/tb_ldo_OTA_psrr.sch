...
C {vsource.sym} 790 -710 0 0 {name=V2 value=0.9 savecurrent=false}
C {isource.sym} 1040 -570 0 0 {name=I0 value=10u}
C {gnd.sym} 790 -630 0 0 {name=l4 lab=GND}
...
C {lab_wire.sym} 840 -840 0 0 {name=p1 sig_type=std_logic lab=vref}
C {lab_wire.sym} 1370 -820 0 0 {name=p2 sig_type=std_logic lab=out}
C {vsource.sym} 880 -750 0 0 {name=V3 value=0.9 savecurrent=false}
C {gnd.sym} 880 -670 0 0 {name=l1 lab=GND}
C {lab_wire.sym} 980 -800 0 0 {name=p3 sig_type=std_logic lab=in}
