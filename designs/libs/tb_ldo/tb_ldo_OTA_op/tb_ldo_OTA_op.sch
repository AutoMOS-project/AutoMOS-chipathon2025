...
C {vsource.sym} 1070 -680 0 0 {name=V2 value=0.9 savecurrent=false}
C {isource.sym} 1320 -540 0 0 {name=I0 value=10u}
C {gnd.sym} 1070 -600 0 0 {name=l4 lab=GND}
...
C {lab_wire.sym} 1120 -810 0 0 {name=p1 sig_type=std_logic lab=vref}
C {lab_wire.sym} 1650 -790 0 0 {name=p2 sig_type=std_logic lab=out}
C {vsource.sym} 1160 -720 0 0 {name=V3 value=0.9 savecurrent=false}
C {gnd.sym} 1160 -640 0 0 {name=l1 lab=GND}
C {lab_wire.sym} 1260 -770 0 0 {name=p3 sig_type=std_logic lab=in}
