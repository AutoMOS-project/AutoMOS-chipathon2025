...
N 1520 -470 1520 -430 {lab=Vr_fb2[19:1],VSS
bus=true}
N 1510 -820 1510 -780 {lab=VOUT}
N 1520 -570 1520 -530 {lab=Vfb,Vr_fb2[19:1] bus=true}
N 1520 -670 1520 -630 {lab=Vr_fb1[3:1],Vfb bus=true}
N 1520 -770 1520 -730 {lab=VOUT,Vr_fb1[3:1] bus=true}
...
N 1050 -1540 1050 -1520 {lab=VSS}
N 1020 -1520 1050 -1520 {lab=VSS}
N 1260 -1540 1260 -1520 {lab=VSS}
N 1230 -1520 1260 -1520 {lab=VSS}
N 1020 -1600 1020 -1520 {lab=VSS}
N 1230 -1600 1230 -1520 {lab=VSS}
N 1020 -1570 1030 -1570 {lab=VSS}
N 1230 -1570 1240 -1570 {lab=VSS}
N 1020 -1600 1050 -1600 {lab=VSS}
N 1230 -1600 1260 -1600 {lab=VSS}
...
C {symbols/ppolyf_u_1k.sym} 1520 -700 0 0 {name=R1[3:0]
W=1e-6
L=5e-6
model=ppolyf_u_1k
spiceprefix=X
m=1}
C {symbols/ppolyf_u_1k.sym} 1520 -500 0 0 {name=R2[19:0]
W=1e-6
L=5e-6
model=ppolyf_u_1k
spiceprefix=X
...
C {lab_wire.sym} 1520 -440 0 1 {name=p9 sig_type=std_logic lab=Vr_fb2[19:1],VSS}
C {lab_wire.sym} 1520 -540 0 1 {name=p10 sig_type=std_logic lab=Vfb,Vr_fb2[19:1]}
C {bus_connect_nolab.sym} 1520 -570 3 0 {name=r3}
C {lab_wire.sym} 1520 -740 0 1 {name=p11 sig_type=std_logic lab=VOUT,Vr_fb1[3:1]}
C {lab_wire.sym} 1520 -640 0 1 {name=p12 sig_type=std_logic lab=Vr_fb1[3:1],Vfb}
...
spiceprefix=X
m=1}
C {symbols/ppolyf_u_1k.sym} 1260 -1570 0 0 {name=Rfb_dummy_TB[15:0]
W=1e-6
L=5e-6
model=ppolyf_u_1k
spiceprefix=X
m=1}
C {lab_wire.sym} 1040 -1520 2 1 {name=p17 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 1250 -1520 2 1 {name=p18 sig_type=std_logic lab=VSS}
