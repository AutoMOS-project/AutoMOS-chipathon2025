...
N 990 -930 1030 -930 {lab=Vx}
N 990 -930 990 -720 {lab=Vx}
...
spiceprefix=X
m=1500}
C {symbols/ppolyf_u_2k.sym} 1550 -780 0 0 {name=R1
W=1e-6
L=1e-6
model=ppolyf_u_2k
spiceprefix=X
m=25}
C {symbols/ppolyf_u_2k.sym} 1550 -640 0 0 {name=R2
W=1e-6
L=1e-6
model=ppolyf_u_2k
spiceprefix=X
...
C {vsource.sym} 1290 -710 3 1 {name=Vtest value=0 savecurrent=false}
C {lab_wire.sym} 1230 -710 0 0 {name=p9 sig_type=std_logic lab=Vx}
C {lab_wire.sym} 1380 -710 0 0 {name=p10 sig_type=std_logic lab=Vy}
