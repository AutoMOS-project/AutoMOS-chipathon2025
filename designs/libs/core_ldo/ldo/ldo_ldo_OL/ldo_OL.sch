...
N 2670 -570 2670 -530 {lab=Vr_fb2[19:1],VSS
bus=true}
N 2660 -920 2660 -880 {lab=VOUT}
N 2670 -670 2670 -630 {lab=VFB_out,Vr_fb2[19:1] bus=true}
N 2670 -770 2670 -730 {lab=Vr_fb1[3:1],VFB_out bus=true}
N 2670 -870 2670 -830 {lab=VOUT,Vr_fb1[3:1] bus=true}
...
C {symbols/ppolyf_u_1k.sym} 2670 -800 0 0 {name=R1[3:0]
W=1e-6
L=5e-6
model=ppolyf_u_1k
spiceprefix=X
m=1}
C {symbols/ppolyf_u_1k.sym} 2670 -600 0 0 {name=R2[19:0]
W=1e-6
L=5e-6
model=ppolyf_u_1k
spiceprefix=X
...
C {lab_wire.sym} 2670 -540 0 1 {name=p19 sig_type=std_logic lab=Vr_fb2[19:1],VSS}
C {lab_wire.sym} 2670 -640 0 1 {name=p20 sig_type=std_logic lab=VFB_out,Vr_fb2[19:1]}
C {bus_connect_nolab.sym} 2670 -670 3 0 {name=r4}
C {lab_wire.sym} 2670 -840 0 1 {name=p21 sig_type=std_logic lab=VOUT,Vr_fb1[3:1]}
C {lab_wire.sym} 2670 -740 0 1 {name=p22 sig_type=std_logic lab=Vr_fb1[3:1],VFB_out}
C {bus_connect_nolab.sym} 2670 -870 0 1 {name=r5}
C {bus_connect_nolab.sym} 2670 -730 2 0 {name=r6}
...
spiceprefix=X
m=1}
C {symbols/ppolyf_u_1k.sym} 2250 -1580 0 0 {name=Rfb_dummy_TB[15:0]
W=1e-6
L=5e-6
model=ppolyf_u_1k
spiceprefix=X
