...
logx=1
logy=0
rawfile=$netlist_dir/tb_bandgap_opamp_ac.raw
sim_type=ac
autoload=1}
...
C {vsource.sym} 590 -470 0 0 {name=V1 value="2 AC \{ac_psrr\}" savecurrent=false}
C {vsource.sym} 660 -500 0 0 {name=V2 
value="1.2 AC \{ac_buffer\}"}
