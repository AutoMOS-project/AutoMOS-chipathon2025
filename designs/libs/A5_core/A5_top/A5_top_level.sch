...
C {libs/A5_core/A5_top/gilbert_mixer/Gilbert_cell_hierarchal_mixing_stage.sym} 1410 -1490 0 0 {name=x_Gilbert_mixer}
C {libs/A5_core/A5_top/gilbert_mixer/Gilbert_cell_hierarchal_loading_stage.sym} 1410 -1840 0 0 {name=x_Gilbert_loading}
C {lab_pin.sym} 1410 -1140 3 0 {name=p15 sig_type=std_logic lab=VDD}
C {libs/A5_core/A5_top/biasing_network/Biasing_network_with_local_mirros.sym} 1140 -660 0 0 {name=x_Biasing_network}
C {libs/A5_core/A5_top/ESD/io_secondary_5p0.sym} 840 -1600 0 1 {name=IO1
spiceprefix=X
}
C {libs/A5_core/A5_top/ESD/io_secondary_5p0.sym} 840 -1430 0 1 {name=IO3
spiceprefix=X
}
...
C {libs/A5_core/A5_top/ESD/io_secondary_5p0.sym} 840 -1240 0 1 {name=IO4
spiceprefix=X
}
C {libs/A5_core/A5_top/ESD/io_secondary_5p0.sym} 840 -1060 0 1 {name=IO5
spiceprefix=X
}
C {libs/A5_core/A5_top/ESD/io_secondary_5p0.sym} 780 -590 0 1 {name=IO2
spiceprefix=X
}
