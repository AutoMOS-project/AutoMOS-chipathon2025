...
lab=VDD}
N 1190 -1950 1190 -1910 {
lab=VDD}
N 1190 -1820 1230 -1820 {
lab=VSS}
N 1190 -1820 1190 -1790 {
lab=VSS}
N 1190 -1790 1190 -1780 {
lab=VSS}
...
C {AutoMOS-chipathon2025/designs/libs/core_top/A5_Time_Transcenders/symbol/Gilbert_cell_hierarchal_mixing_stage.sym} 1410 -1490 0 0 {name=x_Gilbert_mixer}
C {AutoMOS-chipathon2025/designs/libs/core_top/A5_Time_Transcenders/symbol/Gilbert_cell_hierarchal_loading_stage.sym} 1410 -1840 0 0 {name=x_Gilbert_loading}
C {lab_pin.sym} 1410 -1140 3 0 {name=p15 sig_type=std_logic lab=VDD}
C {AutoMOS-chipathon2025/designs/libs/core_top/A5_Time_Transcenders/symbol/Biasing_network_with_local_mirros.sym} 1140 -660 0 0 {name=x_Biasing_network}
C {AutoMOS-chipathon2025/designs/libs/core_top/A5_Time_Transcenders/symbol/io_secondary_5p0.sym} 840 -1600 0 1 {name=IO1
spiceprefix=X
}
C {AutoMOS-chipathon2025/designs/libs/core_top/A5_Time_Transcenders/symbol/io_secondary_5p0.sym} 840 -1430 0 1 {name=IO3
spiceprefix=X
}
...
C {AutoMOS-chipathon2025/designs/libs/core_top/A5_Time_Transcenders/symbol/5T-OTA-buffer_no_hierarchy.sym} 1920 -1740 0 0 {name=x_Amplifier}
C {AutoMOS-chipathon2025/designs/libs/core_top/A5_Time_Transcenders/symbol/Output_stage.sym} 2330 -1720 0 0 {name=x_Output_stage}
...
m=1
hide_texts=True}
C {ipin.sym} 550 -670 2 1 {name=p8 lab=I_BIAS
}
C {ipin.sym} 600 -1960 0 0 {name=p7 lab=VDD}
C {ipin.sym} 550 -510 0 0 {name=p9 lab=VSS}
C {lab_pin.sym} 850 -550 0 0 {name=p10 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 700 -570 0 0 {name=p11 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 760 -1070 0 0 {name=p17 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 760 -1250 0 0 {name=p18 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 760 -1440 0 0 {name=p19 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 760 -1610 0 0 {name=p20 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 1190 -1780 0 0 {name=p21 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 1850 -1600 0 0 {name=p22 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 2160 -1670 0 0 {name=p23 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 1150 -1300 0 1 {name=p24 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 1190 -1950 0 0 {name=p25 sig_type=std_logic lab=VDD}
...
C {AutoMOS-chipathon2025/designs/libs/core_top/A5_Time_Transcenders/symbol/io_secondary_5p0.sym} 840 -1240 0 1 {name=IO4
spiceprefix=X
}
C {AutoMOS-chipathon2025/designs/libs/core_top/A5_Time_Transcenders/symbol/io_secondary_5p0.sym} 840 -1060 0 1 {name=IO5
spiceprefix=X
}
C {AutoMOS-chipathon2025/designs/libs/core_top/A5_Time_Transcenders/symbol/io_secondary_5p0.sym} 780 -590 0 1 {name=IO2
spiceprefix=X
}
