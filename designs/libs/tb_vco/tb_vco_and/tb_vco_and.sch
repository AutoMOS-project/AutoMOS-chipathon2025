...
C {lab_wire.sym} 40 -90 0 0 {name=p3 sig_type=std_logic lab=A}
C {lab_wire.sym} 40 -60 0 0 {name=p4 sig_type=std_logic lab=B}
C {lab_wire.sym} 250 -70 0 0 {name=p5 sig_type=std_logic lab=Y}
...
C {vdd.sym} 140 -130 0 0 {name=l2 lab=VDD}
