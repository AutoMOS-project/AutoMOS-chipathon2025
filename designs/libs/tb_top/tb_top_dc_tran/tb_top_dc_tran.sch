...
N 1380 -490 1380 -470 {lab=#net2}
N 1380 -470 1380 -430 {lab=#net2}
N 1380 -370 1380 -330 {lab=GND}
N 1310 -490 1460 -490 {lab=#net2}
N 1460 -490 1460 -430 {lab=#net2}
N 1460 -370 1460 -310 {lab=GND}
N 1310 -610 1400 -610 {lab=#net3}
...
** Set sources
alter @V1[DC] = $&VDD
alter @V1[PULSE]= [ 0 $&Vstep $&td $&trf $&trf 1 1 1 ]
...
C {vsource.sym} 870 -670 0 0 {name=V4 value=5 savecurrent=false}
...
C {vsource.sym} 930 -670 0 0 {name=V5 value=5 savecurrent=false}
