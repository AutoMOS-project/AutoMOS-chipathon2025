...
C {opin.sym} 1000 -440 0 0 {name=p2 lab=out}
C {iopin.sym} 850 -720 0 0 {name=p3 lab=VDD}
C {iopin.sym} 860 -190 0 0 {name=p4 lab=VSS}
C {symbols/nfet_03v3.sym} 710 -380 0 0 {name=M1
L=0.28u
W=1u
nf=2
m=1
...
C {symbols/pfet_03v3.sym} 710 -500 0 0 {name=M6
L=0.28u
W=1u
nf=4
m=1
