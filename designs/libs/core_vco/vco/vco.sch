...
N 590 -240 620 -240 {lab=VOUT}
N 590 -240 590 -120 {lab=VOUT}
N 590 -120 620 -120 {lab=VOUT}
N 820 -240 850 -240 {lab=#net1}
N 820 -240 820 -120 {lab=#net1}
N 820 -120 850 -120 {lab=#net1}
N 1080 -240 1110 -240 {lab=#net2}
N 1080 -240 1080 -120 {lab=#net2}
N 1080 -120 1110 -120 {lab=#net2}
N 660 -350 660 -270 {lab=#net3}
N 890 -350 890 -270 {lab=#net4}
N 1150 -350 1150 -270 {lab=#net5}
N 660 -210 660 -150 {lab=#net1}
N 660 -180 820 -180 {lab=#net1}
N 890 -210 890 -150 {lab=#net2}
N 890 -180 1080 -180 {lab=#net2}
N 1150 -210 1150 -150 {lab=VOUT}
N 1150 -90 1150 -30 {lab=#net6}
N 1150 -0 1150 30 {lab=VSS}
N 890 0 890 30 {lab=VSS}
N 890 -90 890 -30 {lab=#net7}
N 660 -90 660 -30 {lab=#net8}
...
N 560 -180 590 -180 {lab=VOUT}
N 1300 -180 1300 130 {lab=VOUT}
N 1150 -180 1300 -180 {lab=VOUT}
...
N 1300 130 1300 180 {lab=VOUT}
N 560 190 560 200 {lab=VOUT}
N 410 -430 410 -380 {lab=IBIAS}
N 410 -430 1110 -430 {lab=IBIAS}
N 1110 -430 1110 -380 {lab=IBIAS}
N 850 -430 850 -380 {lab=IBIAS}
N 620 -430 620 -380 {lab=IBIAS}
N 1300 180 1300 200 {lab=VOUT}
N 1470 -240 1470 -220 {lab=VDD}
N 1470 -100 1470 -80 {lab=VSS}
N 1300 200 1300 210 {lab=VOUT}
N 560 -180 560 110 {lab=VOUT}
N 660 -240 730 -240 {lab=VDD}
N 560 110 560 190 {lab=VOUT}
N 1470 -460 1650 -460 {lab=VDD}
N 1480 50 1650 50 {lab=VSS}
N 560 210 1300 210 {lab=VOUT}
N 560 200 560 210 {lab=VOUT}
N 1300 -180 1420 -180 {lab=VOUT}
N 1540 -160 1590 -160 {lab=#net10}
N 1650 -460 1650 -200 {lab=VDD}
N 1650 -120 1650 50 {lab=VSS}
N 340 -380 370 -380 {lab=IBIAS}
N 300 -310 360 -310 {lab=IBIAS}
N 360 -380 360 -310 {lab=IBIAS}
...
C {iopin.sym} 1720 -160 2 1 {name=p4 lab=VOUT}
...
C {libs/core_vco/vco_buffer/vco_buffer.sym} 1590 -120 0 0 {name=x1}
...
C {libs/core_vco/vco_and/vco_and.sym} 1420 -100 0 0 {name=x2}
C {lab_pin.sym} 1470 -240 0 1 {name=p11 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 1470 -80 0 1 {name=p15 sig_type=std_logic lab=VSS}
...
C {symbols/pfet_03v3.sym} 1130 -240 0 0 {name=M7
L=0.28u
W=0.3u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 870 -120 0 0 {name=M8
L=0.28u
W=0.3u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 1130 -120 0 0 {name=M10
L=0.28u
W=0.3u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 640 0 0 0 {name=M11
L=0.28u
W=1u
nf=10
m=4
...
C {symbols/nfet_03v3.sym} 870 0 0 0 {name=M12
L=0.28u
W=1u
nf=10
m=4
...
C {symbols/nfet_03v3.sym} 1130 0 0 0 {name=M13
L=0.28u
W=1u
nf=10
m=4
